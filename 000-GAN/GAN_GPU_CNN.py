...
mnist = datasets.MNIST(root='../data/mnist/',
                       train=True, transform=img_transform, download=True)
...
G = generator(z_dimension, 3136).cuda() #genetator model
...
torch.save(G.state_dict(), './models/generator_CNN.pth')
torch.save(D.state_dict(), './models/discriminator_CNN.pth')